...
//! Primitives for Substrate Proof-of-Capacity (PoC) consensus.
...
pub const POC_ENGINE_ID: ConsensusEngineId = [b'p', b'o', b'c', b'_'];

/// Type of seal.
pub type Seal = Vec<u8>;

/// Type of NonceData
pub type NonceData = Vec<u8>;
...
decl_runtime_apis! {
	...
	/// runtime is safe, putting the PoC algorithm on runtime is not.

//! The conjugate-poc runtime. This can be compiled with `#[no_std]`, ready for Wasm.
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("conjugate-poc"),
	impl_name: create_runtime_str!("conjugate-poc-substrate"),
	authoring_version: 1,
	spec_version: 1,
	impl_version: 1,
...
impl_runtime_apis! {
	...
	impl poc_primitives::TimestampApi<Block, u64> for Runtime {
		fn timestamp() -> u64 {
			timestamp::Module::<Runtime>::get()
		}
	}

	impl poc_primitives::DifficultyApi<Block, conjugatepoc_primitives::Difficulty> for Runtime {
		fn difficulty() -> conjugatepoc_primitives::Difficulty {
			difficulty::Module::<Runtime>::difficulty()
		}
	}

	impl conjugatepoc_primitives::AlgorithmApi<Block> for Runtime {
		fn identifier() -> [u8; 8] {
